...
public:
	...
	static void convertTo(In a, WImageT<unsigned int,C> b, IppRoundMode mode);
	static void convertTo(In a, WImageT<float,C> b, IppRoundMode mode);
	static void convertTo(In a, WImageT<uchar,C> b, IppRoundMode mode, int scaleFactor);
	static void convertTo(In a, WImageT<signed char,C> b, IppRoundMode mode, int scaleFactor);
	static void convertTo(In a, WImageT<short,C> b, IppRoundMode mode, int scaleFactor);
	static void convertTo(In a, WImageT<ushort,C> b, IppRoundMode mode, int scaleFactor);
	static void convertTo(In a, WImageT<int,C> b, IppRoundMode mode, int scaleFactor);
	static void convertTo(In a, WImageT<unsigned int,C> b, IppRoundMode mode, int scaleFactor);
